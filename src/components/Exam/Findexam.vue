  ...
  <div>
    ...
    <el-row v-loading="loading">
      <el-col :md="{span:14,offset:5}">
        ...
        >
          <el-table-column prop="examinationId" label="考试编号" width="180"></el-table-column>
          <el-table-column prop="examinationName" label="考试名称" width="180"></el-table-column>
          <el-table-column prop="creatorId" label="创建者编号" width="180"></el-table-column>
          <el-table-column prop="creatorName" label="考试创建者" width="180"></el-table-column>
        </el-table>
    ...
    search() {
      ...
      Axios.get(
        this.GLOBAL.BASE_REQUEST_URL +
          "/searchOneExamination/" +
          this.keyWords.examinationId
      )
        .then(response => {
